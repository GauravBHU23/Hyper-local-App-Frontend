...
export default function SearchPage() {
  ...
  const { data: results, isLoading, isFetching } = useQuery({
    queryKey: ["search", coords, query, category, radius, availableNow, minRating],
    queryFn: () =>
      servicesApi
        .getNearby({
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        {!coords && (
          <div className="text-center py-12">
            ...
            <p className="text-slate-500">Location detect ho rahi hai...</p>
          </div>
        )}
        ...
        {results?.length === 0 && !isLoading && (
          <div className="text-center py-12 text-slate-400">
            ...
            <p className="text-sm mt-1">Try karo: radius badhao ya filter hatao</p>
          </div>
        )}
